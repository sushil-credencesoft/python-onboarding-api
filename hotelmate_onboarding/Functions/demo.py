...
delete_user_api=f'https://api.thehotelmate.co/api/property/user/delete/{propertyId}'
delete_property_api=f'https://api.thehotelmate.co/api/property/delete/{propertyId}'
