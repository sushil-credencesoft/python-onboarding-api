...
deleteUserApi = f'https://api.bookonelocal.in/api-bookone/api/property/user/delete/{propertyId}'
deletePropertyApi = f'https://api.bookonelocal.in/api/property/delete/{propertyId}'
